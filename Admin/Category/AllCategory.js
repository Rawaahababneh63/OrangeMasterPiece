...
async function getCategory() {
    try {
        const response = await fetch('https://localhost:44332/api/Category');
    ...
    paginatedItems.forEach(category => {
        categoryContainer.innerHTML += `
            <tr>
                ...
                <td><img src="../../../../Backend/Masterpiece/Masterpiece/Uploads/${category.categoryImage}" alt="${category.categoryName}" class="img-fluid" style="height: 50px;"></td>
                <td><button class="btn btn-warning" onclick="getCategoryId(${category.categoryId})">Edit</button>
