...
function displayPaginatedCategories(categories, page, itemsPerPage) {
    ...
    <td>
        <img src="../../../../Backend/Masterpiece/Masterpiece/Uploads/${category.categoryImage}" alt="${category.categoryName}" class="img-fluid" style="height: 50px;">
    </td>
    <td>
<button  class="btn btn-sm btn-primary" onclick="getCategoryId(${category.categoryId})">Edit</button>
